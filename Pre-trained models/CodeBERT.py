...
# File paths for the datasets, here you can add the excel file for which you want to generate embeddings for textual data.
files = ["/home/atif/abhi/Cassandra/cass_pad.xlsx",
         "/home/atif/abhi/Arrow/Arrow_dataset_pad.xlsx",
         "/home/atif/abhi/Airflow/Airflow_pad.xlsx",
         "/home/atif/abhi/Groovy/Groovy_dataset_pad.xlsx",
         "/home/atif/abhi/ISIS/Isis_dataset_pad.xlsx",
         "/home/atif/abhi/Netbeans/Netbeans_dataset_pad.xlsx"]
...
for file in files:
    ...
    model = AutoModel.from_pretrained('microsoft/codebert-base', output_hidden_states=True).to(device)
    batch_size = 256
    ...
    if use_maxpool:
        ...
        np.savetxt(file.split(".")[0]+"_codebert_emb_textual.csv", final_features, delimiter=",")
